...
class MissionConfig:
    ...
    TARGET_FORWARD_CONE_DEG = 80.0
    TREE_ASSOCIATION_DISTANCE = 1.25
    TREE_MAX_UPDATE_JUMP = 1.75
    TREE_VALIDATION_OBSERVATIONS = 4
    TREE_POSITION_ALPHA = 0.18
